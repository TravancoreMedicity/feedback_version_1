...
import { Phone, CalendarRotateSolid} from 'iconoir-react';
import TextComponentBox from '../../Components/TextComponentBox';

const DIschargePatientRemark = ({ PatientRemark }) => {
                    ...
                    GroupPatientRemarkDetail && Object.entries(GroupPatientRemarkDetail)?.map(([date, detail]) => (
                        <Box key={date} sx={{ width: '100%' }}>
                            ...
                            <Box sx={{
                                ...
                                <TextComponentBox name={detail?.fb_imp_remark} size={14} />
                            </Box>
                        </Box>
                    ))
                }
...
export default memo(DIschargePatientRemark);